...
# NOTE: this blueprint is JSON-only and is currently not registered by
# create_app(). Its agents.html template belonged to the old purple UI and
# has been removed; the unused render_template import went with it.
